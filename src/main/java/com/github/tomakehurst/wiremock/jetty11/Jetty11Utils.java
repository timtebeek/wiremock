...
public class Jetty11Utils {
  ...
  public static HttpConfiguration createHttpConfig(JettySettings jettySettings) {
    ...
    httpConfig.setRequestHeaderSize(jettySettings.getRequestHeaderSize().orElse(DEFAULT_HEADER_SIZE));
    httpConfig.setResponseHeaderSize(jettySettings.getResponseHeaderSize().orElse(DEFAULT_HEADER_SIZE));
